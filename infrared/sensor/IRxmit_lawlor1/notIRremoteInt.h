...
//    Crudely modded by Orion Lawlor 2015-11-15 to get variable pwm duty cycle
//
...
#define TIMER_PWM_TO_DUTY(pwmval,dutycycle)  ( pwmval * (long)(dutycycle) / 256u )
...
#define TIMER_CONFIG_KHZ(val, dutycycle) ({ \
	const uint8_t pwmval = SYSCLOCK / 2000 / (val); \
	TCCR2A               = _BV(WGM20); \
	TCCR2B               = _BV(WGM22) | _BV(CS20); \
	OCR2A                = pwmval; \
	OCR2B                = TIMER_PWM_TO_DUTY(pwmval,dutycycle); \
})
...
#define TIMER_CONFIG_KHZ(val,dutycycle) ({ \
	...
	ICR1                  = pwmval; \
	OCR1A                 = TIMER_PWM_TO_DUTY(pwmval,dutycycle); \
})
...
#define TIMER_CONFIG_KHZ(val,dutycycle) ({ \
  ...
  ICR3 = pwmval; \
  OCR3A = TIMER_PWM_TO_DUTY(pwmval,dutycycle); \
})
...
#define TIMER_CONFIG_KHZ(val,dutycycle) ({ \
	...
	TC4H                  = pwmval >> 8; \
	OCR4C                 = pwmval; \
	TC4H                  = TIMER_PWM_TO_DUTY(pwmval,dutycycle) >> 8; \
	OCR4A                 = TIMER_PWM_TO_DUTY(pwmval,dutycycle) & 255; \
})
...
#define TIMER_CONFIG_KHZ(val,dutycycle) ({ \
  ...
  ICR4 = pwmval; \
  OCR4A = TIMER_PWM_TO_DUTY(pwmval,dutycycle); \
})
...
#define TIMER_CONFIG_KHZ(val,dutycycle) ({ \
  ...
  ICR5 = pwmval; \
  OCR5A = TIMER_PWM_TO_DUTY(pwmval,dutycycle); \
})
